...
class loginview : AppCompatActivity() {
    ...
    // to get date of birth from date picker
    ...
    // to check user login credentials from database
                    ...
                    for (p in p0.children) {
                        ...
                        if (user!!.bannerId.equals(enteredBanner) && user!!.DOB.equals(enteredDOB)) {
                            ...
                            val toast = Toast.makeText(
                                applicationContext,
                                "Wrong Banner ID or Date of Birth",
                                Toast.LENGTH_SHORT
                            )
                            toast.show()
                        }
    ...
    // shows user profile if login successful
